...
> "It works" is not proof. **Numbers** are proof.
...
> Do NOT think about the final goal while working on Phase N.
...
> This journal is maintained in `PROGRESS_LOG.md`.
...
> If the architecture is fundamentally wrong, say so. Better to know at Phase 1 than Phase 10.
